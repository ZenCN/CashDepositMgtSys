...
namespace Infrastructure.Helper
{
    ...
    public static class Public
    {
        ...
        public static Component ThrowComponentException(string msg, System.Exception e = null)
        {
            ...
            return e == null ? new Component(string.Format("组件异常：{0}", msg)) : new Component(string.Format("组件异常：{0}", msg), e);
        }
        ...
        /// <param name="msg"> 自定义异常消息 </param>
        /// <param name="e"> 实际引发异常的异常实例 </param>
        public static DataAccess ThrowDataAccessException(string msg, System.Exception e = null)
        {
            if (string.IsNullOrEmpty(msg) && e != null)
            {
                msg = e.Message;
            ...
            return e == null
                ? new DataAccess(string.Format("数据访问层异常：{0}", msg))
                : new DataAccess(string.Format("数据访问层异常：{0}", msg), e);
        }
        ...
        /// <param name="msg"> 自定义异常消息 </param>
        /// <param name="e"> 实际引发异常的异常实例 </param>
        public static Business ThrowBusinessException(string msg, System.Exception e = null)
        {
            if (string.IsNullOrEmpty(msg) && e != null)
            {
                msg = e.Message;
            ...
            return e == null ? new Business(string.Format("业务逻辑层异常：{0}", msg)) : new Business(string.Format("业务逻辑层异常：{0}", msg), e);
        }
