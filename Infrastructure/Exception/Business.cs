...
namespace Infrastructure.Exception
{
    ...
    /// </summary>
    [Serializable]
    public class Business : System.Exception
    {
        /// <summary>
        ...
        public Business(string message, System.Exception inner)
            : base(message, inner) { }
        ...
        protected Business(SerializationInfo info, StreamingContext context)
            : base(info, context) { }
    }
}